...
- `packages/examples` — runnable teaching examples (`counter/`, `form/`, `todo/`, `registration/`) plus `serve.mjs`, a dependency-free static server, and smoke tests that drive the built framework over real HTTP.
